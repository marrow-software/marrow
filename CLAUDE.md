...
│   │   ├── app-sidebar.tsx           # Unified sidebar (#313): workspace switcher (top) → global-nav strip (Home·Search·Inbox·Shared) → active-space tree / surfaced panel → account (bottom). Absorbs the old app-rail. Tree = folders expand/collapse; pages navigate; drag-and-drop, inline create
