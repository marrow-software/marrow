...
- **§2a has not been reviewed by a lawyer** ([#281](https://github.com/marrow-software/marrow/issues/281)). It was aligned to the vetted Project Harmony template in v1.1 ([#286](https://github.com/marrow-software/marrow/issues/286)), which lowers but does not remove the need: the residual gap is chiefly the **undefined "Marrow Software" legal entity** (every precedent names a real company/foundation). Don't promote the CLA as settled, or lean on the relicensing option commercially, until reviewed.
